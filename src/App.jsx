...
function App() {
  return (
    <>
      ...
      <main
        ...
        <div className="border-b border-b-light-3 px-4 pb-4 pt-8 lg:pb-2">
          <label className="relative">
            ...
            <span
              className="absolute inset-y-0 right-0 flex cursor-text items-center pr-4">
              <svg
        ...
        <div className="px-4 py-8">
          ...
          <div className="-mx-4 my-5 overflow-hidden">
            <div
              className="flex snap-x snap-mandatory scroll-px-4 gap-2 overflow-x-auto whitespace-nowrap px-4 py-1 md:flex-wrap">
              <button
                className="snap-start rounded-full border border-dark-grey bg-dark-grey px-4 py-2 text-[14px] text-white outline-none focus:ring-2 focus:ring-dark-grey focus:ring-offset-2">
                Весь список
              </button>
              <button
                className="snap-start rounded-full border border-gold bg-gold/10 px-4 py-2 text-[14px] text-gold outline-none hover:bg-gold hover:text-white focus:border-gold focus:ring-2 focus:ring-gold focus:ring-offset-2">
                Проблемные
              </button>
              <button
                className="snap-start rounded-full border border-red bg-red/10 px-4 py-2 text-[14px] text-red outline-none hover:bg-red hover:text-white focus:border-red focus:ring-2 focus:ring-red focus:ring-offset-2">
                Критические
              </button>
              <button
                className="snap-start rounded-full border border-light-blue bg-light-blue/10 px-4 py-2 text-[14px] text-light-blue outline-none hover:bg-light-blue hover:text-white focus:border-light-blue focus:ring-2 focus:ring-light-blue focus:ring-offset-2">
                Есть замечания
              </button>
              <button
                className="snap-start rounded-full border border-green bg-green/10 px-4 py-2 text-[14px] text-green outline-none hover:bg-green hover:text-white focus:border-green focus:ring-2 focus:ring-green focus:ring-offset-2">
                Выполнено
              </button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <article
              className="flex flex-col gap-4 whitespace-nowrap rounded bg-light-grey p-5 text-sm text-black">
              <div className="flex flex-wrap gap-x-4 gap-y-2">
                <h2
                  className="whitespace-normal text-[18px] font-semibold leading-tight text-blue">
                  Константинопольский Константин Константинович
                </h2>
                <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
                  <span
                    className="rounded bg-white px-2 py-1 text-[13px] text-dark-grey"
                    >ИНН 1234567890</span
                  >
                  <div className="flex items-center gap-2">
                    <span
                      className="rounded bg-green p-1 px-2 text-[13px] text-white"
                      >СМЗ</span
                    >
      ...
      <aside
        className="mt-8 flex flex-col bg-white lg:mt-0 lg:shrink lg:grow-0 lg:basis-1/3">
        {/* <!-- Кнопка --> */}
        <section className="border-b border-b-light-3 px-4 py-8">
          <button
            className="flex w-full items-center justify-center gap-3 rounded border border-light-blue bg-light-blue px-6 py-4 text-base font-medium text-white outline-none ring-light-blue hover:bg-light-blue/80 focus:ring-2 focus:ring-offset-2">
            <svg
        ...
        <section className="px-4 py-8">
          <form className="space-y-4 text-[15px]">
            ...
            <div
              className="grid grid-cols-[repeat(auto-fit,_minmax(235px,_1fr))] gap-5">
              ...
              <fieldset className="space-y-2">
                ...
                <select name="sex" id="sex">
                  <option value="" selected>Без разницы</option>
