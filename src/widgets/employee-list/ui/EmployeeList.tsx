...
import { EmployeeRenderCardList } from '@features/employee/render-card-list';
...
export function EmployeeList() {
  ...
  // const visibleEmployeesCount = useAppSelector((store) => store.filters.status.activeCountVisible)
